    ...
    config = function()
      ...
      for i, ext in ipairs(exts) do
        dap.configurations[ext] = {
          ...
          {
            name = "Node.js: debug server-side (node)",
            type = "node",
            request = "attach",
            port = 9229,
            skipFiles = {},
          ...
          },
          {
            type = "node",
            request = "launch",
            name = "Launch Current File (node with ts-node)",
            cwd = vim.fn.getcwd(),
          ...
          },
          {
            type = "node",
            request = "launch",
            name = "Launch Test Current File (node with vitest)",
            cwd = vim.fn.getcwd(),
          ...
          },
          {
            type = "node",
            request = "launch",
            name = "Launch Test Current File (node with deno)",
            cwd = vim.fn.getcwd(),
          ...
          },
          {
            type = "node",
            request = "attach",
            name = "Attach Program (node, select pid)",
            cwd = vim.fn.getcwd(),
